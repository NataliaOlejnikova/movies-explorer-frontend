    ...
    <section className="main">
      <form className="form-welcome" onSubmit={handleSubmit}>
        ...
        <input
          ...
          required
        ></input>
        <span className='form-welcome__input-error form-welcome__input-error_type_name'></span>
        ...
        <input
          ...
          required
        ></input>
        <span className='form-welcome__input-error form-welcome__input-error_type_email'></span>
